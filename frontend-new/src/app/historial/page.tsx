...
export default function HistorialPage() {
  ...
  const [historicalOrders] = useState<Order[]>([
    ...
    },
    {
      ...
      restaurant: "TESORO",
      time: "Completado",
      items: [{ name: "Tacos de Pescado", quantity: 3, price: 320 }],
      total: 320,
      status: "ready" as const,
      subtotal: 320,
    },
    {
      ...
      restaurant: "ITESO",
      time: "Cancelado",
      items: [{ name: "Combo Especial", quantity: 1, price: 680 }],
      total: 680,
      status: "new" as const,
      subtotal: 680,
    },
    {
      ...
      restaurant: "TESORO",
      time: "Completado",
      items: [{ name: "Ensalada César", quantity: 1, price: 180 }],
      total: 180,
      status: "ready" as const,
      subtotal: 180,
    },
    {
      ...
      restaurant: "TESORO",
      time: "Completado",
      items: [{ name: "Hamburguesa Clásica", quantity: 2, price: 250 }],
      total: 250,
      status: "ready" as const,
      subtotal: 250,
    },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          ...
          <Select value={statusFilter} onValueChange={setStatusFilter}>
            ...
            <SelectContent className="glass-strong">
              ...
              <SelectItem value="ready">Completados</SelectItem>
              <SelectItem value="new">Cancelados</SelectItem>
            </SelectContent>
          </Select>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="glass hover:glass-strong transition-all duration-300 transform hover:scale-[1.02] cursor-pointer">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {historicalOrders.filter((o) => o.status === "ready").length}
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="glass hover:glass-strong transition-all duration-300 transform hover:scale-[1.02] cursor-pointer">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {historicalOrders.filter((o) => o.status === "new").length}
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="glass hover:glass-strong transition-all duration-300 transform hover:scale-[1.02] cursor-pointer">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                ${historicalOrders.filter((o) => o.status === "ready").reduce((sum, o) => sum + o.total, 0)}
              </div>
            </CardContent>
          </Card>
        </div>
